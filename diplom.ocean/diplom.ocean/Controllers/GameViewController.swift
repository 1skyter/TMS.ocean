...
class GameViewController: UIViewController {
    ...
    private func gameOver() {
        ...
        clearObjects()
        scoreLabel.setFont(text: String("\(String.scoreText) \(match!.score) : \(match!.time.asMatchTime())"), size: .scoreFontSize)
    ...
    private func setupView() {
        retryButton.setFont(text: .retryButtonText, size: .buttonSize)
        mainMenuButton.setFont(text: .menuButtonText, size: .buttonSize)
        gameOverLabel.setFont(text: .gameOverText, size: .gameOverFontSize)
    ...
    private func updateScore() {
        inGameScoreLabel.setFont(text: "\(String.scoreText) \(score)", size: .scoreFontSize)
        inGameMultiplyerLabel.setFont(text: "x\(scoreMultiplyer)", size: .scoreFontSize)
    }
