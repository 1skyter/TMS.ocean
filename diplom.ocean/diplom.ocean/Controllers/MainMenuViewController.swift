...
class MainMenuViewController: UIViewController {
    ...
    private func setupUI() {
        startGameButton.setFont(text: .buttonText, size: .buttonFontSize)
        playerNameTextField.setFont(size: .playerNameFontSize)
    ...
    private func setScore() {
        ...
        scoreLabel.setFont(text: "\(String.scoreText)\n\(score)", size: .labelFontSize)
    }
    ...
    @objc func keyboardChanged(_ notification: NSNotification) {
        ...
        if notification.name == UIResponder.keyboardWillHideNotification {
            ...
            fakeLabel.setFont(text: "Type nickname", size: .labelFontSize)
